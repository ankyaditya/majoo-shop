...
<body>
  ...
  <nav class="navbar navbar-expand p-0">
    <a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-2 mr-0" href="{{route('home')}}"> Majoo </a>
        ...
        <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
          ...
          <li>
            <a href="{{route('products.index')}}">
              <span class="fa fa-shopping-bag"></span> Manage Products
            </a>
          </li>
          <li>
            <a href="{{route('orders.index')}}">
              <span class="fa fa-shopping-basket"></span> Manage Orders
            </a>
          </li>
